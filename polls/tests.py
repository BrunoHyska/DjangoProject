...
class QuestionModelTests(TestCase):
    ...
    def test_choice_str_representation(self):
        ...
        choice = Choice(choice_text='Yes')
        self.assertEqual(str(choice), 'Yes')

    def test_question_with_no_choices(self):
        question = create_question(question_text='Do you like Django?', days=-1)
    ...
    def test_choice_vote_count(self):
        question = create_question(question_text='Do you like Django?', days=-1)
        choice1 = Choice.objects.create(question=question, choice_text='Yes', votes=10)
        choice2 = Choice.objects.create(question=question, choice_text='No', votes=5)
        self.assertEqual(choice1.votes, 10)
        self.assertEqual(choice2.votes, 5)
